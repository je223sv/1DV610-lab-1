...
export default class SimpleAi {
     ...
     * @param {String='beginner', 'average', 'expert'} skillLevel - Determines how likely the AI is to answer correctly.
     * @returns {string} - The answer given by the AI.
     */
    ...
    /**
     * Whether the AI should be "hit" with a new card in a game of
     * Black Jack.
     *
     * @param {number} currentScore
     * @param {{String='risky','safe'}} mode - Determines how likely the the AI is to continue.
     * @returns {boolean}
     */
